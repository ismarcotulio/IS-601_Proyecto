...
INSERT INTO [CarDealership_OLTP1].[LOGISTIC].[BRAND] (big_id_PK, var_name, tex_description, int_manufacturer_FK) VALUES 
...
INSERT INTO [CarDealership_OLTP1].[LOGISTIC].[BODY_CLASS] (tin_id_PK, var_name, tex_description) VALUES 
...
INSERT INTO [CarDealership_OLTP1].[LOGISTIC].[VEHICLE_TYPE] (tin_id_PK, var_name, tex_description) VALUES 
...
INSERT INTO [CarDealership_OLTP1].[LOGISTIC].[TRANSACTION_STATE] (tin_id_PK, var_name, tex_description) VALUES 
	(1, 'In Inventory', 'Vehiculo recibido del fabricante y almacenado en el inventario.'),
	(2, 'Returned', 'El cliente devolvio el vehicluo y se coloco en el inventario.'),
	(3, 'For shipment', 'El vehiculo esta siendo preparado para ser entregado al cliente'),
	(4, 'For shipment', 'El vehiculo esta siendo preparado para ser entregado al cliente'),
	(5, 'In inspection', 'El vehiculo esta siendo revisado'),
	(6, 'sold', 'El vehiculo ah sido vendido a un cliente'),
	(7, 'In rent', 'El vehiculo ah sido rentado por un cleinte')
;

INSERT INTO [CarDealership_OLTP1].[LOGISTIC].[MODEL] (big_id_PK, var_name, tex_description, big_brand_FK, tin_body_class_FK) VALUES 
...
INSERT INTO [CarDealership_OLTP1].[LOGISTIC].[VEHICLE] (
	...
	(1, 30000, 'Hydraulic', 5300.0, 4, 8, 'L83 - VVT, AFM (Active Fuel Management), Aluminum', 1, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)', 101, 2014, '1500 SLT', '3GTP1VEC4EG551563', 1, 1, 1, 1),
	(2, 30000, 'Hydraulic', 5300.0, 4, 8, 'LMG', 2, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)', 80, 2010, '1/2 Ton', '1GCSCSE06AZ123805', 1, 1, 1, 2),
	(3, 30000, 'Hydraulic', 5300.0, 4, 8, 'L84 - DI, DFM, ALUM, GEN 5, VAR 2', 1, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)', 80, 2020, '1500 LT', '3GCPWCED5LG130317', 1, 1, 1, 3),
	(4, 31930.00,'Hydraulic', 4600.0, 4, 8, '1UR-FE', 1, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)', 102, 2017, 'UPK51L/USK51L/USK52L/UPK56L/USK56L/USK57L', '5TFRM5F17HX120972', 1, 1, 1, 4),
	(5, 30000, 'Hydraulic', 6000, 2, 8, 'L96', 1, 'Class 2H: 9,001 - 10,000 lb (4,082 - 4,536 kg)', 101, 2012, '2500', '1GT220CG8CZ231238', 1, 1, 1, 4),
	(6, 30000,'Hydraulic', 4300.0, 4, 6, 'LV3 - SIDI, VVT, Aluminum, E85 Max.', 1, 'Class 2F: 7,001 - 8,000 lb (3,175 - 3,629 kg)', 80, 2016, '1500 LT', '1GCVKREH6GZ228691', 1, 1, 1, 1),
	(7, 25000,'Hydraulic', 3600.0, 4, 6, 'LFX - SIDI, VVT, E85 MAX, Aluminum', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 103, 2016, 'LT', '1GCHTCE37G1186784', 1, 1, 1, 2),
	(8, 25000,'Hydraulic', 6200.0, 2, 8, 'LS3', 1, '', 104, 2011, 'Grand Sport 2LT', '1G1YR3DW3B5102190', 2, 1, 1, 5),
	(9, 27785.00,'Hydraulic', 4300.0, 2, 6, 'LV3 - GEN 5, SIDI, VVT: Variable Valve Timing, E85 MAX, ALUM', 1, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)', 80, 2017, '1500', '1GCNCNEH7HZ118773', 1, 1, 1, 1),
	(10, 26543, 'Hydraulic', 3600.0, 4, 6, 'LFX - SIDI, VVT, E85 MAX, Aluminum', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 103, 2016, 'Z71', '1GCGTDE32G1341288', 1, 1, 1, 2), 
    (11, 65432, 'Hydraulic',2700.0, 2 , 4, '2400 CC ', 1, 'Clase 1:6000 lb o menos (2722 kg o menos)', 105, 2014, 'TRN225L / GRN225L', '5TFTX4CN3EX042751', 1,1 , 1,1 ),
    (12, 74432,'Hydraulic',6200.0, 2 , 8, '6.2L (376 ci) V8 DI (455 hp [339.3 kW] a 6000 rpm, 455 l ', 1, '', 78, 2016, '1SS', '1G1FF1R79G0140582 ', 2, 1, 1, 4),
    (13, 85421, 'Hydraulic',5700.0, 4 , 8, ' V8 de 5.7L y 32 V MPFI DOHC ', 1, 'Clase 2: 6,001 - 10,000 lb (2722 -4,536 kg)', 102,2014 , 'UPK51L/ GSK51L / USK51L', '5TFEY5F15EX169621',1 ,1 , 1, 5),
    (14, 23654, 'Hydraulic',2300.0, 4 , 6, '', 1, 'Clase 2E: 6,001 - 7,000 lb (2,722 -3175 kg)',106 ,2019 , '', '1FTER4EH3KLA31326',1 , 1, 1, 1),
	(15, 31835.00,'Hydraulic', 2000.0, 2 , 4, '', 1, '',107 ,2020 , '', 'JM1NDAC74L0413665',2 , 1, 1, 4),
	(16, 31835.00,'Hydraulic', 2300.0, 2 , 4, '', 1, '',106 ,2020 , '', '1FTER1EH1LLA36301',1 , 1, 1, 6),
	(17, 39795,'Hydraulic', 2000, 4 , 4, 'LSY - SIDI, VVT, ALUM, VAR 3', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)',108 ,2019 , 'Sport FWD', '1GYFZER40KF121673',3 , 1, 1, 3),
	(18, 39995,'Hydraulic', 1400.0, 4 , 4, '', 1, 'Class 1C: 4,001 - 5,000 lb (1,814 - 2,268 kg)',109 ,2016 , '', 'ZACCJBAW9GPC62449',3 , 1, 1, 7),
	(19, 39995,'Hydraulic', 2700.0, 4 , 6, '', 1, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)',110 ,2016 , '', '1FTMF1CP3GKD62143',1 , 1, 1, 7),
	(20, 39435,'Hydraulic', 4300.0, 2 , 6, 'LV3 - VVT, Aluminum, E85 Max', 1, '',101 ,2015 , '', '1GTN1TEH9FZ243281',1 , 1, 1, 7),
	(21, 39435,'Hydraulic', 3600.0, 2 , 6, '', 1, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)',111 ,2018 , 'ST', '1C6RR6FG0JS259587',1 , 1, 1, 1),
	(22, 39435,'Hydraulic', 5300.0, 2 , 6, 'LMG - Flex Fuel (Gas/ALC), Cylinder Deactivation Iron', 2, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)',101 ,2013 , '1500', '1GTR1WE07DZ143724',1 , 1, 1, 1),
	(23, 39535,'Hydraulic', 5700.0, 2 , 8, '', 1, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)',111 ,2019 , '1500', '3C6JR6DT3KG560649',1 , 1, 1, 1),
	(24, 44690,'Hydraulic', 5000.0, 2 , 8, '5.0L 4V Premium Fuel', 1, '',93 ,2018 , 'GT Convertible', '1FATP8FF5J5115190',2 , 1, 1, 4),
    (25, 45678,'Estandar', 4000, 4 ,6 , 'V6 de 4.0L 24V MPFI DOHC  ',1 , 'Clase 1D: 5,001 -6,000 lb (2,268 -2722 kg)',106 ,2018 , '  ', '1N6AD0EV5JN745213', 3, 1, 1, 6),
    (26, 55000 ,'Hydraulic ',3300.0, 4 , 6, ' Combustible flexible de 3.3L V6 24V PDI DOHC ', 1, 'Clase 2E: 6,001 - 7,000 lb (2,722 -3,175 kg)',110 ,2018 , '', '1FTEX1CBXJKD41626', 1, 1, 1, 1),
    (27, 452100,'Hydraulic ',3500.0,  4, 6, ' PDI DOHC V6 de 3,5 L y 24 V ', 1, 'Clase 1D: 5,001 - 6,000 lb (2,268 -2,722 kg)',105 ,2016 , 'GRN325L', '3TMAZ5CN7GM019182', 2, 1, 1, 3),
    (28, 28295, 'Estandar ',2000, 2 , 6, ' 2,0 litros ', 1, 'Clase 1C: 4,001 - 5000 lb (1,814 - 2268 kg)',83 ,2020 , 'Deporte', '1C4GJXAN4LW180633',2 , 1, 1,5 ),
    (29, 55000.00 ,'Hydraulic ',2700.0, 4,6 , ' V6 2.7L 24V PDI DOHC Twin Turbo ',1 , 'Clase 2E: 6,001 - 7,000 lb (2,722 -3175 kg)', 110 ,2020 , '', '1FTEW1CP4LFB84170',2 , 1, 1, 6),
    (30, 26495.00 ,'Estandar ',5700.0, 4 ,8 , ' 5.7L V8 16V MPFI OHV ', 1, 'Clase 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)', 111,2017 , 'DS (Ruedas traseras simples)', '3C6JR6DT3HG557601', 1, 1, 1, 3),
	(31, 26775.00,'Estandar ',2500.0, 4 , 4 , ' 2.5L I4 16V GDI DOHC ', 1, 'Clase 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)',103 , 2017, 'LT', '1GCHSCEA7H1203280',3 , 1, 1,3 ),
    (32, 48718.00,'Hidraulic ',5300.0, 4,6 , 'V8 de 5.3L 16V GDI OHV  ', 1, 'Clase 2F: 7,001 -8,000 lb(3,175 - 3,629 kg) ', 80, 2019 , '1500 Work Truck / LS/ Fleet/ Base', '2GCVKNEC8K1187169',1 , 1, 1,1 ),
    (33, 34000.00,'Hidraulic ',5700.00, 4 ,8 , ' DOHC SMPI de 5.7 L y 8 cilindros ', 1, 'Clase 2: 6,001 - 10,000 lb (2,722 - 4,536 kg)', 102, 2013, 'GSK50/ UPK50L', '5TFUY5F19DX303623', 1, 1, 1, 4),
    (34, 48000.00,'Hidraulic ',5300.0, 2, 8 , ' 5,3 litros ',1 , 'Clase 2F: 7,001 - 8,000 lb (3,175 - 3,629 kg)',80 ,2014 , '1500 LT', '1GCVKREC7EZ196951',1 , 1, 1, 5),
    (35, 54456.00,'Hidraulic ',4300.0, 2 , 4, '  ', 1, 'Clase 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)', 80, 2016, '1500 Work Truck', '1GCNCNEH4GZ259783', 1, 1, 1, 10),
    (36, 45346.00,'Hidraulic ',2700.0, 2 , 4, ' DOHC MPFI de 2.7L I4 de 16 V ', 1, 'Clase 1: 6000 lb o menos (2722 kg o menos)',105 , 2012, 'TRN220L/ TRN225L', '5TFTX4CN6CX015282',1 , 1, 1,8 ),
    (37, 61245.00,'Hidraulic ',4300.0,4 , 6, ' 4.3L V6 12V GDI OHV Combustible flexible ',2 , 'Clase 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)',80 ,2014 , '1500 LT', '3GCPCREH5EG437908', 1, 1, 1,10 ),
    (38, 34245.00,'Hidraulic ',3600.0, 4 , 6, ' V6 de 3.6L 24V MPFI DOHC ',1 , 'Clase 1D:5,001 - 6,000 lb (2,268 - 2,722 kg)',83 ,2017 , 'JK', '1C4HJWEG5HL696454',3 ,1 , 1,9 ),
    (39, 10567.00 ,'Estandar ',1500.0, 2 ,4 , ' 1.5L I4 16V GDI DOHC Turbo ',1 , 'Clase 1B: 3001 -4000 lb (1360 - 1814 kg)',112 ,2020 , 'Si/ Si HTP', '2HGFC3A51LH751302', 2, 1, 1,3 ),
    (40, 18940.00 ,'Hidraulic ',1995, 4 , 4, '2.0L I4 16V MPFI DOHC ',1 , 'Clase 1B:3001 - 4000 lb (1360 - 1814 kg)',112 , 2018, 'LX', '19XFC2F59JE206832', 2, 1, 1, 11),
	(41, 47125.00 ,'Hidraulic ',3500.0, 4,6, ' V6 de 3.5L 24V GDI DOHC Twin Turbo ', 1, 'Clase 2F: 7,001 - 8,000 lb (3,175 - 3,629 kg)',110 ,2017 , 'XLT / King Ranch', '1FMJU1JT1HEA52352', 3,1 , 1, 7),
    (42, 21340.00,'Hidraulic ',1995, 4 ,6 , 'V6 de 3.5  ',1 , 'Clase 1B:3001 - 4000 lb (1360 - 1814 kg)',112 ,2018 , 'EX', '2HGFC2F74JH589649', 3,1 , 1,9 ),
    (43, 44321.00,'Hidraulic ',3700.00,4  ,6 , '  V6 de 3.7L 24V MPFI DOHC', 1, 'Clase 2E: 6,001 - 7,000 lb (2722 -3175 kg)', 110, 2013, '', '1FTEX1CMXDFB16329',1 ,1 , 1, 6),
    (44, 28295.00,'Hidraulic ',3600.00, 2 ,6 , ' V6 de 3.6L 24V MPFI DOHC ',1 , 'Clase 1C: 4,001 .5,000 lb (1,814 -2,268 kg)', 83, 2020, 'Deporte', '1C4GJXAG9LW193038', 3,1 , 1,8 ),
    (45, 34567.00,'Hidraulic ',4000.0, 2 ,4 , ' V6 de 4.0L 24V MPFI DOHC ', 1, 'Clase 1: 6000 lb o menos (2722 kg o menos)', 105 , 2012, 'TRN240L', '3TMLU4EN4CM085701',1 , 1, 1, 10),
	(46, 34567.00,'Hidraulic ',2700.0,  4,6 , '2,7 litros', 1, 'Clase 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)',110 , 2019, '', '1FTEW1CP2KKC65268',1 , 1, 1, 10),
    (47, 37890.00,'Hidraulic ',2500.0, 5, 6, ' 2.5L I4 16V MPFI DOHC Híbrido',1 , 'Clase 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)',113 , 2015, 'AGZ10L / AGZ15L', 'JTJBJRBZ8F2020836', 3,1 , 1, 3),
    (48, 41500.00,'Hidraulic ',2000, 5 , 6, ' 2.0L I4 16V GDI DOHC Turbo ', 1, 'Clase 1D: 5,001 - 6,000 lb (2,268 - 2722 kg)', 114,2018 , '', 'SADFJ2FX1J1Z13468', 3,1 , 1,6 ),
    (49, 35678.00,'Hidraulic ',1300.0, 4 ,6 , '  ', 1 , 'Clase 1C:4,001 - 5,000 lb (1,814 - 2,268 kg)', 115, 2020, 'Esencia AWD', 'KL4MMGSL4LB128069',3,1 , 1,9 ),
    (50, 36870.00,'Hidraulic ',2000.0,5, 4, ' 2.0L 4 cilindros ', 1, 'Clase 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 113,2020 , 'AGZ10L - AWTLTA', 'JTJAARBZ1L2159357', 3,1 , 1,11 ),
    (51, 37890.00,'Hidraulic ',2500.0, 4 ,6 , 'Turbo de 2.5L I5 20V MPFI DOHC ', 1, 'Clase 1C: 4,001 - 5,000 lb (1,814 - 2,268 kg)',116 ,2016 , '', 'YV4612UMXG2000759', 3, 1, 1,15 ),
    (52, 24567.00,'Hidraulic ',2000.0, 4,6 , '  ',1 , '', 116, 2019, '', '7JRA22TL6KG004114',2 ,1 , 1, 6),
    (53, 45678.00,'Hidraulic ',2000.0, 4,4 , '2.0L I4 16V GDI DOHC Turbo ',1 , '', 116, 2020, 'FWD/eAWD(T8)', '7JR102FK7LG060315', 2, 1, 1, 14),
    (54, 43213.00,'Hidraulic ',2000.0, 4,6 , '2.0L I4 16V GDI DOHC Turbo  ', 1, '', 116, 2019, 'FWD/ eAWD(T8)', '7JR102FK4KG010003', 2, 1, 1, 12),
    (55, 41500.00,'Hidraulic ',2000.0, 4 ,6 , '2.0L I4 16V GDI DOHC Turbo', 1, 'Clase 1D: 5,001 - 6,000 lb(2,268 - 2,722 kg)',13 , 2018, 'Q5 quattro Premium', 'WA1ANAFY7J2102310',3 ,1 , 1,5 ),
    (56, 53980.00,'Hidraulic ',3500.0, 4, 6, ' V6 de 3,5 L 24 V MPFI DOHC', 1, 'Clase 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)',117 ,2015 , 'Estilo de carroceria de vagon', '5N1AL0MM5FC519184', 3,1 , 1,4 ),
    (57, 47675.00,'Hidraulic ',2700.0,4 ,6 ,' V6 GTDI de 2.7L',1 , '', 21, 2017, '', '1LN6L9TP6H5634048',2 , 1, 1,7 ),
    (58, 44195.00,'Hidraulic ',2000.0,4 ,4 , ' 2.0L I4 16V GDI SOHC Turbo ',1 , 'Clase 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 17, 2018, 'TI Q4', 'ZASFAKBN3J7B64774',3 , 1, 1,6 ),
    (59, 54321.00,'Hidraulic ',1798.0,5,6 , '1.8L I4 16V MPFI DOHC', 1, '',31 ,2016 , 'ZRE186L', 'JTNKARJEXGJ517925', 2, 1, 1, 9),
    (60, 45672.00,'Hidraulic ',3670.70, 5 , 6, ' V6 de 3,7 L y 24 V MPFI SOHC ',1 , 'Clase 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)',117 , 2013, 'Tecnologia', '2HNYD2H30DH510846',3 ,1 , 1,8 ),
	(61, 43561.00,'Hidraulic ',3670.70, 5, 6 , 'V6 de 3,7 L y 24 V MPFI SOHC ', 1, 'Clase 1D: 5,001 -6,001 lb (2,268 - 2,722 kg)',118,2013 , 'Tecnologia', '2HNYD2H30DH510840',3,1 , 1,7 ),
    (62, 49700.00,'Hidraulic ',2000.0, 4,4 , ' Motor de cuatro cilindros TFSI de 2.0 litros y 2.0 litros ', 1, '', 13 ,2018 , 'A6 2.0 T Sport', 'WAUC8AFC6JN041814',2 ,1 , 1, 5),
	(63, 35780.00,'Hidraulic ',2400.0, 4 ,6, ' 2.4L I4 16V GDI DOHC ',1, '',119 ,2015 , 'Sport \/ Limited \/ Sport 2.0', '5NPE34AF8FH021634',2 , 1, 1, 5),
    (64, 40521.00,'Hidraulic ',2400.0, 4 ,6, '5.7L V8 16V MPFI OHV',1 , '',111 , 2015, 'Sport \/ Limited \/ Sport 2.0', '3C6RR7KT7HG794054',2 ,1 , 1, 6),
    (65, 35100.00,'Hidraulic ',5300.0, 4, 6, ' 5.3L V8 16V GDI OHV ',1 , 'Class 2F: 7,001 - 8,000 lb (3,175 - 3,629 kg)', 21, 2019 , '1500 Fleet\/Base 4WD', '3C6RR7KT7HG794053',1 ,1 , 1, 8),
    (66, 30400.00,'Hidraulic ',5300.0, 2 , 4, ' 5.3L V8 16V MPFI OHV Flexible Fuel',2 , 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)',101 ,2013 , '1500', '1GTR1WE01DZ407455',1 ,1 , 1, 10),
    (67, 46140.00,'Hidraulic ',6200.00, 4 ,8 , ' 6.2L V8 16V MPFI SOHC Flexible Fuel ',1 , 'Class 2H: 9,001 - 10,000 lb (4,082 - 4,536 kg)',120 , 2019, 'Super Duty - Single Rear Wheel', '1FTBF2B65KEC91136',1 ,1 , 1,3),
    (68, 27895.00,'Hidraulic ',3600.0, 4 ,6 , ' 3.6L V6 24V MPFI DOHC ',1 , 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)',83 ,2018 , 'Unlimited Sport', '1C4BJWDG2JL806552',3 ,1 , 1, 11),
    (69, 30145.00,'Hidraulic ',2000, 4 , 4, ' 2.0L I4 16V GDI DOHC Turbo ',1 , 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)',83 ,2019 , 'Unlimited Sahara', '1C4HJXEN4KW505794',3 ,1 , 1, 6),
    (70, 37445.00,'Hidraulic ',3600.0, 4 , 6, ' 3.6L V6 24V MPFI DOHC ',1 , 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 83, 2017, 'JK', '1C4BJWFG3HL547853',3 ,1 , 1, 1),
    (71,38295.00 ,'Hidraulic ',3600.0, 4 , 6 , ' 	3.6L V6 24V MPFI DOHC ',1 , 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)',83 ,2018 , 'Unlimited Sahara', '1C4HJXEGXJW175675',3 ,1 , 1, 6),
    (72, 35200.00,'Hidraulic ', 3600.0, 4 , 6, ' 3.6L V6 24V GDI DOHC ',1 , 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)', 121, 2018, 'SLE 2 FWD', '1GKKNLLS2JZ178034',3 ,1 , 1, 6),
    (73, 37000.00,'Hidraulic ',2000.0, 4 ,4 , ' 2.0 L ',1 , '',122 ,2013 , 'FWD', '3LN6L2G99DR819673', 2 ,1 , 1, 6),
    (74, 38350.00,'Hidraulic ',3600.0 ,4  ,6 , ' 3.6L V6 24V GDI DOHC ',1 , 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)',121 ,2017 , 'SLT 1', '1GKKNMLS2HZ305977',3 ,1 , 1, 6),
    (75, 35170.00,'Hidraulic ',2000, 4 , 4, ' 2.0L I4 16V GDI DOHC Turbo ', 1, '',122 , 2017, 'SLT 1', '3LN6L5A97HR666209',3 ,1 , 1, 6),
    (76, 40700.00,'Hidraulic ', 2000.0, 5 , 4, ' 2.0L I4 16V PDI DOHC Turbo ',1 , 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 123, 2015, 'AGZ10L\/AGZ15L\/AYZ10L\/AYZ15L', 'JTJYARBZ9F2013419',3 ,1 , 1, 1),
    (77, 42370.00,'Hidraulic ', 2000.0, 5 , 4, ' 2.0L I4 16V PDI DOHC Turbo ',1 , 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 123, 2016, 'AGZ10L\/AGZ15L\/AYZ10L\/AYZ15L', 'JTJYARBZ5G2041512',3 ,1 , 1, 12),
    (78, 24200.00,'Hidraulic ',1300.0, 5 ,3 , ' 1.3L I3 12V MPFI DOHC Turbo ',1 , 'Class 1C: 4,001 - 5,000 lb (1,814 - 2,268 kg)', 115, 2020, 'Select FWD', 'KL4MMDSL8LB104338',3 ,1 , 1, 6),
    (79, 44300.00,'Hidraulic ', 2000, 5 , 4, ' 2.0L I4 16V GDI DOHC Turbo ', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 114, 2018, 'D150 FWD', 'SADFP2FX0J1Z05358',3 ,1 , 1, 6),
    (80, 45000.00,'Hidraulic ',1948, 4 , 4, ' 2.0L I4 16V GDI DOHC Turbo ', 1, '',116 , 2018, 'Inscription AWD', 'LYV402TK9JB177497',3 ,1 , 1, 4),
    (81, 37000.00,'Hidraulic ',2000.0, 4 , 4, ' 2.0L I4 16V GDI DOHC ', 1, '',116 ,2019 , 'Inscription AWD', '7JRA22TM2KG013336', 2,1 , 1, 6),
    (82, 42500.00,'Hidraulic ',2000.0, 4 , 4, ' 2.0L I4 16V GDI DOHC ', 1, '', 116, 2019, 'Inscription AWD', '7JRA22TM4KG006873', 2,1 , 1, 8),
    (83, 38500.00,'Hidraulic ',2000.0, 4 , 4, ' 2.0L I4 16V GDI DOHC ', 1, '', 116, 2019, 'Inscription AWD', '7JRA22TM4KG006870', 2,1 , 1, 5),
    (84, 31295.00,'Hidraulic ',4300.0, 5 , 6, ' 4.3 L ', 1, 'Class 2G: 8,001 - 9,000 lb (3,629 - 4,082 kg)', 124, 2018, '2500', '1GCWGAFP8J1309579',1 ,1 , 1, 15),
    (85, 36000.00 ,'Hidraulic', 4300.0, 5 , 6, ' 4.3 L ',1 , 'Class 2G: 8,001 - 9,000 lb (3,629 - 4,082 kg)', 124, 2019, '2500 cargo', '1GCWGAFP4K1214373', 1,1 , 1, 6),
    (86, 36500.00,'Hidraulic ', 4300.0, 5 , 6, ' 4.3 L ', 1, 'Class 2G: 8,001 - 9,000 lb (3,629 - 4,082 kg)', 124, 2018, '2500', '1GCWGAFPXJ1337903',1 ,1 , 1, 5),
    (87, 44350.00,'Hidraulic ', 3500.0, 4 ,6 , ' 3.5L V6 24V GDI DOHC ',1 , 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 125, 2020, 'Crossover', '5N1DL0MN9LC508268',3 ,1 , 1, 14),
    (88, 46695.00, 'Hidraulic ',2000, 4 , 4, ' 2.0L I4 16V GDI SOHC Turbo ', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 71, 2018, 'Ti SPORT Q4', 'ZASFAKNN6J7B70368',3 ,1 , 1, 7),
    (89, 47675.00,'Hidraulic ',3700.0, 4 , 6, ' 3.7L V6 24V MPFI DOHC ',1 , '', 122, 2017, 'select', '1LN6L9TK4H5636420', 2,1 , 1, 6),
    (90, 41500.00,'Hidraulic ',2000.0, 4 , 4, ' 2.0L I4 16V GDI DOHC Turbo ', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 13, 2018, 'Q5 quattro Premium', 'WA1ANAFY2J2198475', 3,1 , 1, 6),
    (91, 22500.00,'Hidraulic ',2400.0, 4 , 4, ' 2.4L I4 16V GDI DOHC ', 1, '', 119, 2018, 'SEL, SEL w\/ Tech, Limited, Limited w\/ Ultimate, Sport ,Sport 2.0T, Limited 2.0T', '5NPE34AF7JH658815',2 ,1 , 1, 13),
    (92, 72850.00,'Hidraulic ',2000, 4 , 4, ' 2.0L I4 16V GDI DOHC Turbo ', 1, '', 126, 2018, 'A6 2.0T quattro premium plus', 'WAUG8AFC8JN040987',2 ,1 , 1, 15),
    (93, 19000.00,'Hidraulic ',1798, 5 , 4, ' 1.8L I4 16V MPFI DOHC ', 1, '', 127, 2016, 'ZRE186L', 'JTNKARJE4GJ508198',2 ,1 , 1, 11),
    (94, 44400.00,'Hidraulic ',3500.0, 5 ,6 , ' 3.5L V6 24V GDI SOHC ', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 118, 2020, 'luxury crossover SUV[', '5J8YD4H39LL041518', 3,1 , 1, 9),
    (95, 29540.00,'Hidraulic ',3600.0, 2 ,6 , ' 3.6L V6 24V MPFI DOHC', 1, 'Class 1C: 4,001 - 5,000 lb (1,814 - 2,268 kg)', 83, 2019, 'Sport', '1C4GJXAGXKW566358', 3,1 , 1, 5),
    (96, 27970.00,'Hidraulic ',3600.0, 4 ,6 , ' 3.6L V6 24V MPFI DOHC',1 , 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 83, 2012, 'JK', '1C4BJWDG5CL258372', 3,1 , 1, 13),
    (97, 23070.00 ,'Hidraulic ',2500.0, 4 , 4, ' 2.5L I4 16V MPFI DOHC ', 1, '', 128, 2017, 'ASV50L\/GSV50L\/AVV50L', '4T1BF1FK4HU421581',2 ,1 , 1, 10),
	(98, 42095.00 ,'Hidraulic ',5700.0, 4 , 8, '', 1, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)', 111, 2017, 'DS (Single Rear Wheels)', '1C6RR6VT3HS551162',1 ,1 , 1, 1),
	(99, 37445 ,'Hidraulic ',3600.0, 4 , 6, '', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 83, 2017, 'JK', '1C4BJWFG7HL558919',3 ,1 , 1, 1),
	(100, 27895 ,'Hidraulic ',3600.0, 4 , 6, '', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 83, 2017, 'JK', '1C4BJWDG7HL689576',3 ,1 , 1, 2),
	(101, 27895 ,'Hidraulic ',3600.0, 4 , 6, '', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 83, 2017, 'JK', '1C4BJWDG8HL671975',3 ,1 , 1, 3),
	(102, 27895 ,'Hidraulic ',3600.0, 4 , 6, '', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)', 83, 2017, 'JK', '1C4BJWDG6HL650381',3 ,1 , 1, 4),
	(103, 46990 ,'Hidraulic ',2997.1940056, 2 , 6, '', 1, '', 129, 2012, '1-Series', 'WBAUP9C53CVL91190',2 ,1 , 1, 5),
	(104, 30445 ,'Hidraulic ',3600.0, 4 , 6, '', 1, '', 130, 2018, 'LX', '2C3CCAEG6JH123125',2 ,1 , 1, 3),
	(105, 20995 ,'Hidraulic ',2000, 5 , 4, 'MIVEC', 1, 'Class 1C: 4,001 - 5,000 lb (1,814 - 2,268 kg)', 131, 2020, 'Medium', 'JA4AP3AU9LU013694',3 ,1 , 1, 7),
	(106, 19410 ,'Hidraulic ',1800.0, 4 , 4, '', 1, '', 132, 2013, '', '3N1AB7AP2DL658501',2 ,1 , 1, 5),
	(107, 35200.00 ,'Hidraulic',3600.0, 4 , 6, 'LGX - Direct Injection, Variable Valve Timing, ALUM, GEN 2', 1, '', 121, 2018, 'SLE 2 FWD', '1GKKNLLS5JZ181591',3 ,1 , 1, 2),
    (108, 45876.00,'Hidraulic ',3600.0, 4 ,6 , ' 3.6L V6 24V GDI DOHC ', 1, 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)',121 , 2020, 'Denali AWD', '1GKKNXLS6LZ134810',3 ,1 , 1, 12),
    (109, 34567.00,'Hidraulic ',3600.0, 4 ,6 , ' 3.6L V6 24V GDI DOHC ',1 , 'Class 2E: 6,001 - 7,000 lb (2,722 - 3,175 kg)',121 ,2020 , 'SLT1 AWD', '1GKKNULSXLZ132766', 3, 1, 1,4 ),
    (110, 38500.00,'Hidraulic ',2000.0, 4 , 4, ' 2.0L I4 16V GDI DOHC Turbo ', 1, '', 122, 2018, 'Select', '3LN6L5C91JR615484', 2, 1, 1, 3),
	(111, 31200.00,'Hidraulic ',1000.0, 2 , 3, ' 1.0L I3 12V MPFI DOHC ', 1, '',133 ,2013 , '', 'WMEEJ3BA2DK636540', 2, 1, 1, 9),
	(112, 29087.00,'Hidraulic ',2000.0, 5, 4, ' 2.0L I4 16V PDI DOHC Turbo ', 1, 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)',123 ,2015 , 'AGZ10L\/AGZ15L\/AYZ10L\/AYZ15L', 'JTJBARBZ6F2000472',3 ,1 , 1, 7),
	(113, 32156.00,'Hidraulic ',1300.0, 4 , 3, ' 1.3L I3 12V MPFI DOHC Turbo ', 1, 'Class 1C: 4,001 - 5,000 lb (1,814 - 2,268 kg)',115,2020 , 'Select FWD', 'KL4MMDSL6LB104869', 3,1 , 1,1 ),
	(114, 49200.00,'Hidraulic ',2000.0, 5 ,4 , ' 2.0L I4 16V GDI DOHC Turbo ',1 , 'Class 1D: 5,001 - 6,000 lb (2,268 - 2,722 kg)',114 , 2020, '', 'SADFL2GX2L1Z91107',3 , 1, 1,10 ),
	(115, 32145.00,'Hidraulic ',2500.0, 4 ,5 , ' 2.5L I5 20V MPFI DOHC Turbo ', 1, '', 116, 2015, '', 'YV1612TBXF1304224', 2, 1, 1,9 ),
	(116, 35987.00,'Hidraulic ',2000.0,  4,4 , ' 2.0L I4 16V GDI DOHC ',1 , '',116 ,2020 , '', '7JRA22TM7LG032143', 2, 1, 1,11 ),
	(117, 43210.00,'Hidraulic ',2000.0, 4 ,4 , ' 2.0L I4 16V GDI DOHC ',1 , '', 116,2020 , '', '7JRA22TL7LG037835', 2,1 , 1,13 ),
	(118, 54400.00,'Hidraulic ',2000.0, 2 , 4, '  ',2 , '',116 , 2019, 'FWD\/eAWD (T8)', '7JRBR0FM4KG013841', 2, 1, 1,14 ),
	(119, 49370.00,'Hidraulic ',2700.0, 4 , 6, '  ', 1, '',122 ,2018 , 'Select', '1LN6L9TP1J5605689',2 , 1, 1, 15)
