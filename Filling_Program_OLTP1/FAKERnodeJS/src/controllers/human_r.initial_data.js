...
export const dataFill = async (req, res) => {
    ...
    await pool.request()
    .query("INSERT INTO TYPE_HOURS(flo_porcent,var_name) VALUES (130,'Dia de semana/Mañana'),"
    ...
    await pool.request()
    .query("INSERT INTO MOVEMENT(tex_description,int_factor,mon_amount) VALUES ('Costo de vida',1,5000),"
    ...
    await pool.request()
    .query("INSERT INTO COUNTRY VALUES (1,'Honduras','504'),"
    +"(2,'Cuba','53'), (3,'Costa Rica','506'), (4,'Colombia','57')"
    +", (5,'Salvador','503'), (6,'Nicaragua','505')")
    await pool.request()
    .query("INSERT INTO DEPARTAMENT(var_name,int_country_id_FK) VALUES ('Francisco Morazán',1), "
    +"('Comayagua',1), ('Cortés',1), ('Choluteca',1), ('Villa Clara',2), ('Limón',3), ('Córdoba',4), "
    +"('Santa Ana',5), ('Managua',6)")
    await pool.request()
    .query("INSERT INTO CITIES(var_name,big_departament_id_FK) VALUES ('Tegucigalpa',1), ('Comayagua',2),"
    +" ('San Pedro Sula',3), ('Choluteca',4), ('Santa Clara',5), ('Pococi',6), ('Valencia',7),('Santa Ana',8),"
    +" ('El Crucero',9)")
    await pool.request()
    .query("INSERT INTO SUBURN VALUES (1,'Colonia Kennedy',1), (2,'Barrio Torondon"
    +"',2), (3,'Colonia Satelite',3), (4,'Colonia Vanecia',4), (5,'Reparto Virginia',5), (6,'Los Lagos',6), (7,'Ensanche',7),"
    +" (8,'Socorro',8), (9,'Las Conchitas',9)")
    await pool.request()
    .query("INSERT INTO LIST_ADDRESS(tex_reference,int_country_id_FK,big_departament_id_FK,big_city_id_FK"
    ...
    +"',6,9,9,9)")
    await pool.request()
    .query("INSERT INTO BRANCH_OFFICES VALUES (1,'Sucursal de Tegucigalpa',1), (2,'Sucursal de Comayagua'"
